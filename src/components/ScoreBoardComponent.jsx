...
class ScoreBoard extends Component {
  ...
  async getHistory() {
    ...
    await axios.get(baseUrl + "historypractices/gethistorypracticebyinformation").then((response) => {
      let data_student = response.data;
        this.setState({ data_student });
    });
    await axios.get(baseUrl + "authorhistorypractices/gethistorypracticebyinformation").then((response) => {
